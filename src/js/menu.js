...
const fullMenuData = [
  {
    ...
    rating: 4.9,
    reviews: 234,
    description: "Rendang sapi premium bumbu rempah asli.",
    image: "Rendang Sapi Premium.jpg",
    badge: "Best Seller",
    spicy: 2,
  },
  {
    ...
    rating: 4.8,
    reviews: 189,
    description: "Ayam kampung bakar saus madu spesial.",
  ...
  },
  {
    ...
    rating: 4.7,
    reviews: 167,
    description: "Soto kuah bening dengan koya spesial.",
  ...
  {
    id: 4,
    name: "Nasi Goreng Syummm",
    category: "main",
    price: 32000,
    rating: 4.8,
    reviews: 201,
    description: "Nasi goreng spesial telur mata sapi.",
    image: "Nasi Goreng Syummm.jpg",
    badge: "Best Seller",
    spicy: 2,
  },
  {
    ...
    rating: 4.7,
    reviews: 156,
    description: "Lumpia rebung segar khas Semarang.",
  ...
  {
    id: 14,
    name: "Teh Tarik Mas Duiki",
    category: "drink",
    price: 15000,
    rating: 4.8,
    reviews: 312,
    description: "Teh tarik foam lembut ala Malaysia.",
    image: "Teh Tarik Mas Duiki.jpg",
    badge: "Best Seller",
    spicy: 0,
  },
  {
    id: 15,
    name: "Teh Ijo Susu Mbak Gita",
    category: "drink",
    price: 18000,
    rating: 4.9,
    reviews: 289,
    description: "Green tea latte creamy premium.",
    image: "Teh Ijo Susu Mbak Gita.jpg",
    badge: "New",
    spicy: 0,
  },
  {
    id: 17,
    name: "Klepon Mini Box",
    category: "dessert",
    price: 22000,
    rating: 4.8,
    reviews: 198,
    description: "Klepon mini gula merah cair lumer.",
    image: "Klepon Mini Box.jpg",
    badge: "Best Seller",
    spicy: 0,
  },
...
function renderMenu() {
  ...
  menuContainer.innerHTML = filteredData
        ...
        <div class="bg-white rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 group">
            ...
            <div class="p-6">
                ...
                <div class="flex justify-between items-center">
                    ...
                    <button onclick="addToCartFromMenu(${item.id})" class="bg-dark text-white p-3 rounded-xl hover:bg-primary transition-colors cursor-pointer">
...
function updateMenuCount() {
  ...
  const count =
    currentCategory === "all"
      ? fullMenuData.length
      : fullMenuData.filter((i) => i.category === currentCategory).length;
...
function showNotification(message) {
  ...
  toast.className =
    "toast-notification fixed bottom-10 left-1/2 -translate-x-1/2 bg-dark/90 backdrop-blur-sm text-white px-8 py-4 rounded-2xl shadow-2xl z-[10000] flex items-center gap-4 transition-all duration-500 opacity-0 translate-y-10 border border-white/10";
  toast.innerHTML = `
        <div class="flex items-center gap-3 bg-white/90 backdrop-blur-md border border-gray-100 p-3 pr-6 rounded-2xl shadow-2xl max-w-[90vw] md:max-w-md animate-in fade-in slide-in-from-bottom-4 duration-300">
      ...
      <div class="flex flex-col">
          <span class="text-[10px] uppercase tracking-widest text-gray-400 font-bold">Notifikasi</span>
          <span class="font-bold text-sm md:text-base text-dark leading-tight tracking-wide">
              ${message}
          </span>
      </div>
  </div>
