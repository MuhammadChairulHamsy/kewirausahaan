  ...
  if (menuToggle && navMenu) {
    menuToggle.addEventListener("click", (e) => {
      ...
      if (!navMenu.classList.contains("hidden")) {
        navMenu.className =
          "nav-menu flex flex-col items-center gap-4 absolute top-full left-0 w-full bg-white p-6 shadow-xl border-t border-gray-100 lg:static lg:flex-row lg:w-auto lg:p-0 lg:shadow-none lg:border-none";
      } else {
  ...
  const menuData = [
    {
      ...
      price: 85000,
      img: "Rendang Sapi Premium.jpg",
    },
    {
      id: 2,
      name: "Ayam Bakar Madu",
      price: 55000,
      img: "Ayam Bakar Madu.jpg",
    },
    {
      id: 3,
